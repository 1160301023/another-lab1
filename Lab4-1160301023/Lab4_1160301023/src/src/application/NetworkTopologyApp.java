...
public class NetworkTopologyApp {
    ...
    public static void main(String[] args) throws Exception{
        ...
        Graph<Vertex, Edge> graph = new NetworkTopologyFactory().createGraph(scan.next());
        if (graph == null)
        ...
        }}catch (NetworkTopologyLabelException e) {
            // TODO: handle exception
            System.out.println(e.message());
        }catch (DataMissingException e) {
            // TODO: handle exception
            System.out.println(e.message());
        }catch (NetworkTopologyStartEndException e) {
            // TODO: handle exception
            System.out.println(e.message());
        }catch (NetworkTopologyVertexTypeException e) {
            // TODO: handle exception
            System.out.println(e.message());
        }
